    ...
    public function run(): void
    {
        ...
        $crossSourceRules = [
            ...
            [
                ...
                'category' => 'accounting',
                'left' => ['source_type' => 'financial_statement', 'canonical_metrics' => ['lo_surplus_deficit'], 'period_mode' => 'annual_snapshot', 'skpd_mode' => 'exact', 'report_scope' => ['official_report']],
                'right' => ['source_type' => 'financial_statement', 'canonical_metrics' => ['lpe_surplus_deficit'], 'period_mode' => 'annual_snapshot', 'skpd_mode' => 'exact', 'report_scope' => ['official_report']],
            ],
            [
                'code' => 'ACC-004',
                'name' => 'Ekuitas Neraca vs Ekuitas Akhir LPE',
                'category' => 'accounting',
                'left' => ['source_type' => 'financial_statement', 'canonical_metrics' => ['balance_equity'], 'period_mode' => 'annual_snapshot', 'skpd_mode' => 'exact', 'report_scope' => ['official_report']],
                'right' => ['source_type' => 'financial_statement', 'canonical_metrics' => ['lpe_ending_equity'], 'period_mode' => 'annual_snapshot', 'skpd_mode' => 'exact', 'report_scope' => ['official_report']],
            ],
        ];
