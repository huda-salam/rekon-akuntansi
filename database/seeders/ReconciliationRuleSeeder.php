    ...
    public function run(): void
    {
        ...
        $crossSourceRules = [
            [
                ...
                'right' => ['source_type' => 'financial_statement', 'canonical_metrics' => ['lra_revenue'], 'period_mode' => 'any', 'skpd_mode' => 'exact'],
            ],
            [
                'code' => 'ACC-002',
                ...
                'right' => ['source_type' => 'financial_statement', 'canonical_metrics' => ['lra_expenditure'], 'period_mode' => 'any', 'skpd_mode' => 'exact'],
            ],
            [
                'code' => 'ACC-003',
                'name' => 'Surplus/(Defisit) LO vs LPE',
                'category' => 'accounting',
                'left' => ['source_type' => 'financial_statement', 'canonical_metrics' => ['lo_surplus_deficit'], 'period_mode' => 'any', 'skpd_mode' => 'exact'],
                'right' => ['source_type' => 'financial_statement', 'canonical_metrics' => ['lpe_surplus_deficit'], 'period_mode' => 'any', 'skpd_mode' => 'exact'],
            ],
            [
                'code' => 'ACC-004',
                'name' => 'Ekuitas Neraca vs Ekuitas Akhir LPE',
                'category' => 'accounting',
                'left' => ['source_type' => 'financial_statement', 'canonical_metrics' => ['balance_equity'], 'period_mode' => 'any', 'skpd_mode' => 'exact'],
                'right' => ['source_type' => 'financial_statement', 'canonical_metrics' => ['lpe_ending_equity'], 'period_mode' => 'any', 'skpd_mode' => 'exact'],
            ],
        ];
