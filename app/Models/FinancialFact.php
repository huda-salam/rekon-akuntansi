...
class FinancialFact extends Model
{
    protected $fillable = [
        ...
        'fact_date','period','source_type','transaction_type','document_number',
        'account_code','metric','value','unit','dimensions',
    ];

    protected $casts = ['fact_date'=>'date','value'=>'decimal:2','dimensions'=>'array'];
